package cn.yan_wm.myalbum.service.linux.service.Impl;
...
import cn.yan_wm.myalbum.service.linux.job.MyJob;
import cn.yan_wm.myalbum.service.linux.server.Server;
import cn.yan_wm.myalbum.service.linux.service.MonitorService;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    @Override
    public String monitorCpu(Server server) {
        Connection conn = connection(server);
        try
        {
            //连接到主机
    ...
    public String readCpu(Connection conn) throws IOException {
